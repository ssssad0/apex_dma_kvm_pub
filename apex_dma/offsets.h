...
#define OFFSET_ENTITYLIST 0x01f60fa0 + 0xA8 //[ConVars].gamepad_aim_assist_melee updated 2024/09/26 # [Miscellaneous].cl_entitylist
#define OFFSET_LOCAL_ENT 0x24342B8 //[Miscellaneous].LocalPlayer updated 2024/09/20
#define OFFSET_NAME_LIST 0xd426160 //[Miscellaneous].NameList updated 2024/09/26
#define OFFSET_GLOBAL_VARS 0x18351c0 //[Miscellaneous].GlobalVars updated 2024/09/20
#define OFFSET_MATRIX 0x11a350 //[Miscellaneous].ViewMatrix updated 2024/09/26
#define OFFSET_RENDER 0x76e88b8 //[Miscellaneous].ViewRender updated 2024/09/26
...
#define OFFSET_STUDIOHDR 0x1000 //[Miscellaneous].CBaseAnimating!m_pStudioHdr updated 2024/09/26
#define OFFSET_BULLET_SCALE 0x19d8 + 0x04f4  //[WeaponSettingsMeta].base + [WeaponSettings].projectile_gravity_scale updated 2024/09/26
#define OFFSET_BULLET_SPEED 0x19d8 + 0x04ec  //[WeaponSettingsMeta].base + [WeaponSettings].projectile_launch_speed updated 2024/09/26
...
#define OFFSET_BONES 0x0db0 + 0x48 //[RecvTable.DT_BaseAnimating].m_nForceBone + 0x48 updated 2024/09/26
...
#define OFFSET_HEALTH 0x0328 //[RecvTable.DT_Player].m_iHealth updated updated 2024/09/26
...
#define OFFSET_CAMERAPOS 0x1ee0 //[Miscellaneous].CPlayer!camera_origin updated 2024/09/26
#define OFFSET_MODELNAME 0x0030 //[DataMap.C_BaseEntity].m_ModelName updated 2024/09/18

#define OFFSET_ARMORTYPE 0x4724 //[RecvTable.DT_Player].m_armorType updated updated 2024/09/26
#define OFFSET_ZOOMING 0x1be1 //[RecvTable.DT_Player].m_bZooming updated 2024/09/26
#define OFFSET_PLATFORM_UID 0x2548 //[RecvTable.DT_Player].m_platformUserId updated 2024/09/26
#define OFFSET_LIFE_STATE 0x0690 //[RecvTable.DT_Player].m_lifeState updated 2024/09/26
#define OFFSET_BLEED_OUT_STATE 0x2760 //[RecvTable.DT_Player].m_bleedoutState updated 2024/09/26
#define OFFSET_VIEWANGLES 0x2534 - 0x14 //[RecvTable.DT_Player].m_ammoPoolCapacity - 0x14 updated 2024/09/26
#define OFFSET_BREATH_ANGLES OFFSET_VIEWANGLES - 0x10 //updated 1/11/2024
#define OFFSET_ACTIVE_WEAPON 0x18d8 + 0x0058 //[RecvTable.DT_Player].m_inventory + WeaponInventory_Client>activeWeapons updated 2024/09/26
#define OFFSET_VIEW_MODELS 0x2d98 //[RecvTable.DT_Player].m_hViewModels updated 2024/09/26
#define OFFSET_GRAPPLE 0x2cc0 //[RecvTable.DT_Player].m_grapple updated 2024/09/26
#define OFFSET_GRAPPLE_ACTIVE 0x2d50 //[RecvTable.DT_Player].m_grappleActive updated 2024/09/26
#define OFFSET_GRAPPLE_ATTACHED 0x0048 //[RecvTable.DT_GrappleData].m_grappleAttached updated 2024/09/20
#define OFFSET_SKYDRIVESTATE 0x4784 //[RecvTable.DT_Player].m_skydiveState updated 2024/09/26
...
#define OFFSET_INPUT_SYSTEM 0x18e3640 //[Miscellaneous].InputSystem updated 2024/09/26 
#define OFFSET_IN_ATTACK 0x076e89c0 //[Buttons].in_attack updated 2024/09/26
#define OFFSET_IN_TOGGLE_DUCK 0x076e89e0 //[Buttons].in_toggle_duck updated 2024/09/26
#define OFFSET_IN_ZOOM 0x076e8b38 //[Buttons].in_zoom updated 2024/09/26
#define OFFSET_IN_FORWARD 0x076e88f0 //[Buttons].in_forward updated 2024/09/26
#define OFFSET_IN_JUMP 0x076e8aa8 //[Buttons].in_jump updated 2024/09/26
#define OFFSET_IN_DUCK 0x076e8bb0 //[Buttons].in_duck updated 2024/09/26
#define OFFSET_IN_BACKWARD 0x076e8918 //[Buttons].in_backward updated 2024/09/26
#define OFFSET_IN_USE 0x076e8b28 //[Buttons].in_use updated 2024/09/26

#define OFFSET_ITEM_ID 0x1568 //[RecvTable.DT_PropSurvival].m_customScriptInt updated 2024/09/26  
...
#define HIGHLIGHT_SETTINGS 0xb1da3a0 //[Miscellaneous].HighlightSettings updated 2024/09/26
#define HIGHLIGHT_TYPE_SIZE 0x34 //updated 1/10/2024

////Silent
#define OFFSET_PCOMMANDS 0x022fce20 - 0xF40//[ConCommands].-scriptCommand9 +0xF40 pCommands updated 2024/09/26
#define OFFSET_LATEST_COMMAND_NUMBER 0x1712124 //LatestCommandNumber updated 2024/04/23
#define OFFSET_NET_CHANNEL 0x1835500 + 0x60 //[Miscellaneous].ClientState NetChannel +0x60 updated 2024/09/26
...
#define OFFSET_HOST_MAP 0x01750c90 + 0x58 //[ConVars].host_map + 0x58 updated 2024/09/26
...
#define OFFSET_PRIMARY_WEAPON 0x1944 //[RecvTable.DT_BaseCombatCharacter].m_latestPrimaryWeapons updated 2024/09/26
